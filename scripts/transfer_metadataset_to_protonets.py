...
vgg11 = {
    "name": "vgg11", 
    "model_dir": "learners/cnaps/models/meta-trained_meta-dataset_protonets_vgg11.pt", 
...
transfer_checkpoint_dir = os.path.join("/home/etv21/rds/hpc-work/protonets_TARGETFEAT_target", dataset) 

transfer_cmd = "python3 ./learners/cnaps/src/run_cnaps.py \\\n\
        --dataset from_file \\\n\
        --data_path DATA_PATH \\\n\
        --checkpoint_dir TRANSFER_CHECKPOINT_DIR \\\n\
        --feature_extractor TARGETFEAT \\\n\
        --pretrained_resnet_path PRETRAINED_FEATURE_EXTRACTOR \\\n\
...
for t_set in transfer_settings:
    ...
    task_cmd = task_cmd.replace("MODEL_BACKBONE", t_set["model_dir"])
    ...
    output_file.close()
    print("chmod +x {}".format(script_loc))
    print("sbatch /home/etv21/rds/hpc-work/torch_job_runner.sh {}".format(script_loc))
